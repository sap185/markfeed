    ...
    <header className="bg-gray-500">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" className="text-sm font-semibold text-white">Integration</a>
          <a href="#" className="text-sm font-semibold text-white">Pricing</a>
        </PopoverGroup>

        <div className="hidden lg:flex lg:flex-1 lg:justify-end space-x-4">
          <Link to="/Login" aria-label="Log in"><a className="text-sm font-semibold text-white">Log in</a></Link>
          <p className='text-white'>/</p>
          <Link to="/Signup" aria-label="Log in"><a className="text-sm font-semibold text-white">Sign Up</a></Link>
        </div>
      </nav>
